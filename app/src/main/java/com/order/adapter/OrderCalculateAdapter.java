...
public class OrderCalculateAdapter extends BaseAdapter {
	public Context context;
	public ArrayList<Order> orderlist;
	private static LayoutInflater inflater = null;

	public OrderCalculateAdapter(Context context, ArrayList<Order> orderlist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (view == null) {
			view = inflater.inflate(R.layout.order_calculate_item, null);
